    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                ...
                <a href="tambahcustomer.php" class="btn btn-primary btn-sm d-flex justify-content-center">Tambah Data
                    Customer</a>
                ...
                <table class="table table-striped table-hover table-sm">
                    ...
                    while ($row = $hasil->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            <a href="editcustomer.php?edit=<?= $row['id_cust']; ?>"
                                    class="btn btn-warning btn-sm">Edit</a> <a
                                    href="koneksi.php?id_cust=<?= $row['id_cust']; ?>" class="btn btn-danger btn-sm"
